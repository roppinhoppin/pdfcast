...
That is, the function $f$ dominates $g$ in the limit $v\rightarrow w$ . For example, $f$ is continuous at $\boldsymbol{w}$ if and only if  
...
![](images/3a18e468e9fce1aef48eecfb7b00e484b26fd4a480db1d1bac2f11e45e21c80b.jpg)  
...
For a multi-input function, twice di!erentiability is simply defined as the di!erentiability of any directional derivative $\partial f({\pmb w})[{\pmb v}]$ w.r.t. $\mathbf{\delta}w$ .  